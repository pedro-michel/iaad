...
CREATE TABLE `vendedores` (
  ...
  `codigo_regiao` VARCHAR(2) DEFAULT NULL,
  `sobrenome_vendedor` VARCHAR(10) DEFAULT NULL,
...
('01','Marcio',10,'01','silva'),
('02','Gisele',15,'02','silva'),
('03','Michele',12,'05','silva'),
('04','Viviane',9,'03','silva'),
('05','Rafaela',8,'04','silva'),
('06','Institucional',1,'05','silva'),
('07','Pedro',80,'02','Michel');
